    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="pcoded-hasmenu pcoded-trigger">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="feather file-plus"></i></span>
                    <span class="pcoded-mtext">Product Setting</span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="pcoded-hasmenu pcoded-trigger">
                <a href="javascript:void(0)">
                    ...
                    <span class="pcoded-mtext">Company Setting</span>
                </a>
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="{{Route('website_info.edit',$id=1)}}">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="">
                <a href="{{url('files\extra-pages\landingpage\index.htm')}}" target="_blank">
            ...
            <li class="pcoded-hasmenu ">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-hasmenu ">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="">
                                <a href="{{url('files\extra-pages\email-templates\email-welcome.htm')}}">
                                    <span class="pcoded-mtext">Welcome Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{url('files\extra-pages\email-templates\email-password.htm')}}">
                                    <span class="pcoded-mtext">Reset Password</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{url('files\extra-pages\email-templates\email-newsletter.htm')}}">
                                    <span class="pcoded-mtext">Newsletter Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{url('files\extra-pages\email-templates\email-launch.htm')}}">
                                    <span class="pcoded-mtext">App Launch</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{url('files\extra-pages\email-templates\email-activation.htm')}}">
