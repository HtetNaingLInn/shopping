                    ...
                    <tbody>
                      {{-- @php($no=0) --}}
                        ...
                        <tr>
                            ...
                            <td>{{$banner->Status}}</td>
                            <td>
                                <button class="btn btn-success btn-round" data-toggle="modal" data-target="#edit_modalBox" wire:click="setData({{$banner->id}})">Edit</button>
                                <button class="btn btn-danger btn-round" wire:click="deleteCity({{$banner->id}})">Delete</button>
                            </td>
                        </tr>
                        @endforeach
